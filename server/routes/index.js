...
//查询商品数据接口 views/Search/Search-list.vue
router.get('/api/goods/shopList',function(req,res,next){
	//前端给后端的数据
	let [searchName,orderName] = Object.keys(req.query);//a b
	let [name,order] = Object.values(req.query);//1,2
...
//首页大红袍的数据 插件ly-tab views/Home.vue addData()
